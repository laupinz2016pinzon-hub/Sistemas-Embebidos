/**
 * @file CalculadoraBasica.ino
 * @brief Calculadora básica de enteros con señalización LED en Arduino.
 * 
 * Implementa suma, resta, multiplicación y división de enteros.
 * El LED integrado emite patrones según el resultado:
 *  - 1 flash: resultado positivo
 *  - 2 flashes: resultado negativo
 *  - 3 flashes: resultado cero
 */

const int ledPin = 13;  // LED integrado en Arduino Uno

/**
 * @brief Inicializa la comunicación serie y configura el pin del LED.
 */
void setup() {
  Serial.begin(9600);
...
/**
 * @brief Parpadea el LED integrado un número específico de veces.
 * Cada flash consiste en encender el LED por 500 ms y apagarlo por 500 ms.
 * @param flashes Número de flashes a realizar.
 */
...
/**
 * @brief Muestra el menú de operaciones en la consola serie.
 */
void mostrarMenu() {
...
/**
 * @brief Lee un número entero desde la consola serie.
 * @return int Número entero ingresado.
 */
int leerEntero() {
